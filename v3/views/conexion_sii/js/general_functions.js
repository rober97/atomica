  ...
  getInfo()
    .then(res => {
      ...
      if (res.data.logged_in) {
        if (res.data.connected_sii | res.data.bandeja_dtc_unabase) {
          switch (ref) {
            case `login`:
            ...
            case `list_dtc`:
              ...
              break;
            case `standby_screen`:
              if (res.data.connection_sii_status | res.data.bandeja_dtc_unabase)
                location.href = `${window.location.origin}/v3/views/conexion_sii/view/list_dtc.html?v=${rnd}`;
...
const getServerInfo = async () => {
  getInfo()
    .then(res => {
      ...
      localStorage.setItem('bandeja_dtc_unabase', res.data.bandeja_dtc_unabase);
