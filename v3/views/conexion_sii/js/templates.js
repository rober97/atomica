...
const templates = {
    ...
    select: s_ => {
        ...
        let select = `<div class="input-group mb-3">
    ...
    <select class="form-select" id="select${s_.id}" idelement="${s_.id}" idelement2="${s_.id0}">`;
        ...
        if (allItem === 'true') {
            select += `<option id="0">TODOS</option>`;
        }
    ...
    list: l_ => {
        ...
        let lista =
            `<ol class="list-group list-group-numbered" id="list-content">`;
        ...
        const genList = ls_e => {
            ...
            ls_e.forEach(function (l_ele) {
                ...
                ls += `<li class="list-group-item  justify-content-between align-items-start">
                        ...
                        <div class="ms-2 row ${l_ele.class1}" style="" data-type="${l_ele.type ? l_ele.type : 'neg'}"      >
                        ...
                        <div class="justify-content-end  col-md-12 col-lg" style="" > 
    ...
    alerta: a_ => {
        return `<div class="alert alert-${a_.type} alert-dismissible fade show w-50 p-3 mx-auto" role="alert" style="font-weight:bolder;">
                   ${a_.msg}
