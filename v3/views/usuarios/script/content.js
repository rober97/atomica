...
$(document).ready(function() {
    ...
    unaBase.toolbox.menu.init({
      ...
      buttons: ['save','exit'],
      data: function(){
        $('input[name="ots_valor_hh_recursos"]').val($('input[name="ots_valor_hh_recursos_aux"]').val());
      ...
      validate: function() {
        ...
        var login = container.find('input[name="usuario[loguinsito]"]').val();
        var pass = container.find('input[name="usuario[clavesita]"]').val();
