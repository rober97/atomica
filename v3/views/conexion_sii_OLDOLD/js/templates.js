                    ...
                    <div style="margin-bottom: 50px;"> ${l_ele.button1.length > 0 ? genAdicional([l_ele.button1[1],l_ele.button2[1]]) : ''}  </div>
                        <div class="justify-content-end  col-md-12 col-lg" style="" > 
                                ...
                                <div class="mb-2 d-flex justify-content-between align-items-center">
                                    <div class="position-relative"> <span class="position-absolute search"><i class="fa fa-search"></i></span> <input class="form-control w-100" placeholder="Buscador"> </div>
                                    <div class="px-2"> <span>Filters <i class="fa fa-angle-down"></i></span> <i class="fa fa-ellipsis-h ms-3"></i> </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-responsive table-borderless table-negocios">
                                        <thead>
                                            <tr class="bg-light">
