const generarChart = (gastop, gastor, chartid) => {
    var densityCanvas = document.getElementById(chartid);
    
    let title, label1, label2;
    switch (chartid) {
        ...
        case "presupuestado-chart":
            {
                title = 'Gasto presupuestado / Gasto real'
                label1 = 'Gasto presupuestado'
                label2 = 'Gasto real'
                break;
            }
    }
...
var refreshSummary = function() {
    ...
    */
    ...
    generarChart(presupuestado.costo.value.toFixed(currency.decimals).replace('.', ','), costoreal, "presupuestado-chart");
