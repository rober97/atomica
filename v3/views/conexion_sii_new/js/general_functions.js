    ...
    if(res.data.connected_sii){
      switch (ref) {
        case `login`:
          if(!res.data.connection_sii_status)
            location.href = `${window.location.origin}/v3/views/conexion_sii_new/view/standby_screen.html`;
          else
            location.href = `${window.location.origin}/v3/views/conexion_sii_new/view/list_dtc.html`;

          break;
        case `list_dtc`:
          if(!res.data.connection_sii_status)
            location.href = `${window.location.origin}/v3/views/conexion_sii_new/view/stanby_screen.html`;
      ...
      switch (ref) {
        ...
        case `standby_screen`:	
          ...
          break;
        case `index`:	
          location.href = `${window.location.origin}/v3/views/conexion_sii_new/view/login.html`;
