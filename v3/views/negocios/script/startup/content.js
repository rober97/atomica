...
$(document).ready(function() {
		...
		console.warn('contest.js from script/startup');
	...
	*/
	...
	htmlObject.appendTo('table.items  thead  ul.dropdown-<ul class="dropdown-menu-actions" style="text-align: left;">menu-actions').menu().hide();
